<%@ Page Title="Registrar um logon externo" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="LIMSReporterWeb.Account.RegisterExternalLogin" Async="true" %>
